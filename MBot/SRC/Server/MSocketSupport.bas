...
Private Function WindowProc(ByVal hwnd As Long, ByVal uMsg As Long, ByVal wParam As Long, ByVal lParam As Long) As Long
    ...
    If uMsg = SOCKET_MESSAGE Then
        ...
        '
    ElseIf uMsg = RESOLVE_MESSAGE Then
        '
...
'********************************************************************************
    ...
    lngRetValue = WSAAsyncSelect(lngSocketHandle, m_lngWindowHandle, SOCKET_MESSAGE, lngEvents)
    '
...
'********************************************************************************
    ...
    'instance of the CSocket class by the task ID vakue the following
    ...
    If lngAddress = INADDR_NONE Then
        ...
        lngRequestID = WSAAsyncGetHostByName(m_lngWindowHandle, RESOLVE_MESSAGE, strHostAddress, ByVal lngMemoryPointer, MAXGETHOSTSTRUCT)
        '
    Else
        '
        'strHostAddress contains an IP address, resolve by address to get a host name
        lngRequestID = WSAAsyncGetHostByAddr(m_lngWindowHandle, RESOLVE_MESSAGE, lngAddress, 4&, AF_INET, ByVal lngMemoryPointer, MAXGETHOSTSTRUCT)
        '
    End If
    '
...
'********************************************************************************
    ...
    Else
        ...
        '
        Debug.Print "The window is created: " & m_lngWindowHandle
        '
    End If
    '
End Function
...
'********************************************************************************
    ...
    '
    Debug.Print "The window " & m_lngWindowHandle & " is destroyed"
    '
